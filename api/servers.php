...
if (isset($_GET['templates'])) {
    jsonResponse([
        ...
        ['name' => 'Conan Exiles',             'app_id' => '443030',  'launch_executable' => './ConanSandbox/Binaries/Linux/ConanSandboxServer-Linux-Shipping',  'launch_args' => '-MaxPlayers=40 -Port=7777 -QueryPort=27015 -log',                                                    'port' => 7777,  'max_players' => 40 ],
