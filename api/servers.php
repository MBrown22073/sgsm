...
if (isset($_GET['templates'])) {
    jsonResponse([
        ...
        ['name' => 'Conan Exiles',             'app_id' => '443030',  'launch_executable' => './ConanSandbox/Binaries/Win64/ConanSandboxServer.exe', 'launch_args' => '-MaxPlayers=40 -Port=7777 -QueryPort=27015 -log',                                                    'port' => 7777,  'max_players' => 40 ],
        ...
        ['name' => 'V Rising',                 'app_id' => '1829350', 'launch_executable' => './VRisingServer.exe',              'launch_args' => '-persistentDataPath ./save-data -serverName "V Rising" -maxConnectedUsers 40',                       'port' => 9876,  'max_players' => 40 ],
    ]);
}
